    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSearch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent searchIntent = new Intent(Home.this, SearchResultsActivity.class);
...
//        adapter.stopListening();
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if (id == R.id.nav_home) {
            ...
            editor.clear(); // Xóa tất cả thông tin lưu trữ
            editor.apply();

            // Chuyển đến màn hình đăng nhập và xóa tất cả các Activity khác trên stack
    ...
    private void showChangPassworDiaglog() {
        ...
        alertdiglog.setTitle("Thay đổi mật khẩu");
        alertdiglog.setMessage("Làm ơn điền tất cả thông tin!");
        ...
        //button
        alertdiglog.setPositiveButton("Lưu", new DialogInterface.OnClickListener() {
            @Override
        ...
        alertdiglog.setNegativeButton("Huỷ", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int i) {
                dialog.dismiss();
            }
